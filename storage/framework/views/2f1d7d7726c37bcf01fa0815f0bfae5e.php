<?php $__env->startSection('title', 'Tambah Kos - PUSATKOS'); ?>

<?php $__env->startSection('owner-content'); ?>
...
<div class="card border-0 shadow-sm" style="border-radius: 8px;">
    <div class="card-body p-4 p-md-5">
        ...
        <form id="form-create-kos" class="ts-form" method="POST" action="#">
            ...
            <a href="<?php echo e(route('owner.kos.index')); ?>" class="btn btn-outline-dark font-weight-bold px-4">Batal</a>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Thinkpad\Downloads\pusatkos-laravel\resources\views/owner/kos/create.blade.php ENDPATH**/ ?>