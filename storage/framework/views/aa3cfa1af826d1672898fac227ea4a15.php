<?php $__env->startSection('title', 'Tagihan / Invoice - PUSATKOS'); ?>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('owner.kos.show', $kos['slug'] ?? 'kos-putri-melati')); ?>">Property</a></li>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($invoice['kos']); ?></td>
                                        <td>Rp <?php echo e(number_format($invoice['amount'], 0, ',', '.')); ?></td>
                                        <td><?php echo e($invoice['due_date']); ?></td>
                                        <td>
                                            <span class="badge <?php echo e($invoice['status'] === 'Lunas' ? 'badge-success' : 'badge-warning'); ?>">
                        ...
                        <div class="col-lg-8">
                            <div class="ts-box ts-box-payment">
                                ...
                                <div class="property-mini-card">
                                    <div class="property-name"><?php echo e($invoices[0]['kos'] ?? '-'); ?></div>
                                    <div class="property-address">
                                        <i class="fa fa-map-marker mr-1"></i>
                                        <?php echo e($invoices[0]['kos'] ?? '-'); ?>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <span class="badge badge-light badge-status ml-2">
                                            ...
                                            <?php echo e($invoices[0]['invoice_number'] ?? '-'); ?>
                                ...
                                <form id="payment-form" action="#" method="POST">
                                    ...
                                    <input type="hidden" name="property_id" value="<?php echo e($invoices[0]['invoice_number'] ?? ''); ?>">
                                    <input type="hidden" name="property_name" value="<?php echo e($invoices[0]['kos'] ?? ''); ?>">
                            ...
                            <div class="ts-box ts-box-payment">
                                ...
                                <div class="payment-summary-box">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span><strong>Rp <?php echo e(number_format($invoices[0]['amount'] ?? 0, 0, ',', '.')); ?></strong></span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span><strong class="text-primary" style="font-size:18px;">Rp <?php echo e(number_format($invoices[0]['amount'] ?? 0, 0, ',', '.')); ?></strong></span>
                                    </div>
                                </div>
                                ...
                                <div class="payment-total-box mt-3">
                                    ...
                                    <div class="total-amount">Rp <?php echo e(number_format($invoices[0]['amount'] ?? 0, 0, ',', '.')); ?></div>
                                ...
                                <div class="text-center mt-3">
                                    <a href="<?php echo e(route('owner.kos.show', $kos['slug'] ?? 'kos-putri-melati')); ?>" class="btn btn-link text-decoration-none">
...
<script>
        ...
        $('#payment-form').on('submit', function (e) {
            ...
            `;
                ...
                setTimeout(function () {
                    window.location.href = '<?php echo e(route('customer.invoice.index')); ?>';
                }, 3000);
            }, 2000);
        });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Thinkpad\Downloads\pusatkos-laravel\resources\views/customer/invoice/index.blade.php ENDPATH**/ ?>