...
<?php $__env->startSection('title', 'Tentang PUSATKOS - PUSATKOS'); ?>
...
<div class="ts-page-wrapper ts-has-bokeh-bg" id="page-top">
    ...
    <main id="ts-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <a href="<?php echo e(route('owner.kos.create')); ?>" class="btn btn-primary">Daftar Jadi Mitra Pemilik Kos</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card ts-person ts-card h-100">
                            <a href="#" class="card-img" data-bg-image="<?php echo e(asset('assets/img/img-person-01.jpg')); ?>"></a>
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card ts-person ts-card h-100">
                            <a href="#" class="card-img" data-bg-image="<?php echo e(asset('assets/img/img-person-02.jpg')); ?>"></a>
                            <div class="card-body">
                                <h4>Andi Prasetyo</h4>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card ts-person ts-card h-100">
                            <a href="#" class="card-img" data-bg-image="<?php echo e(asset('assets/img/img-person-03.jpg')); ?>"></a>
                            <div class="card-body">
                                <h4>Fitri Anindya</h4>
                ...
                <div class="container">
                    <div class="offset-lg-2 col-lg-8 mx-auto">
                        <div class="owl-carousel" data-owl-items="1" data-owl-dots="1">
                            <div class="ts-slide">
                                <div class="ts-circle__sm mx-auto" data-bg-image="<?php echo e(asset('assets/img/img-person-04.jpg')); ?>"></div>
                            ...
                            <div class="ts-slide">
                                <div class="ts-circle__sm mx-auto" data-bg-image="<?php echo e(asset('assets/img/img-person-05.jpg')); ?>"></div>
        ...
        <section id="about-us-numbers" class="py-5 text-white text-center ts-separate-bg-element" data-bg-color="#000037" data-bg-image="<?php echo e(asset('assets/img/bg-apartment-table.jpg')); ?>" data-bg-image-opacity=".3">
        ...
        <section id="partners" class="ts-block py-4">
            <div class="container">
                <div class="d-block d-md-flex justify-content-between align-items-center text-center ts-partners py-3">
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-01.png')); ?>" alt=""></a>
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-02.png')); ?>" alt=""></a>
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-03.png')); ?>" alt=""></a>
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-04.png')); ?>" alt=""></a>
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-05.png')); ?>" alt=""></a>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\PUSATKOS\resources\views/owner/tentang.blade.php ENDPATH**/ ?>