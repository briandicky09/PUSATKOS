        ...
        <div class="container py-4">
            ...
            <div class="card border-0 shadow-sm mb-5" style="border-radius: 8px;">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('owner.kos.index') }}" method="GET">
            ...
            <div class="row">
                ...
                @endforeach
                        ...
                        <div class="card-footer bg-white border-top-0 pb-4 pt-0">
                            <a href="{{ route('owner.kos.show', $kos['slug'] ?? 'kos-putri-melati') }}" class="btn btn-outline-dark w-100 font-weight-bold" style="border-radius: 4px;">Lihat Detail</a>
                        </div>
                    </div>
                </div>
