...
<?php $__env->startSection('title', 'Masuk - PUSATKOS'); ?>
                            ...
                            <form id="form-login" class="ts-form" method="POST" action="#">
                                ...
                                <div class="text-center mt-4 ts-text-small">
                                    <p class="mb-0 text-muted">
                                        Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="font-weight-bold" style="color: #007bff; text-decoration: underline;">Daftar di sini</a>
                                    </p>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\PUSATKOS\pusatkos-integrasi laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>