        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarPrimary">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?php echo e(request()->routeIs('owner.kos.index') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('owner.kos.index')); ?>">Cari Kos</a>
                    </li>
                    <li class="nav-item">
...
<?php /**PATH C:\Users\USER\PUSATKOS\pusatkos-integrasi laravel\resources\views/partials/navbar.blade.php ENDPATH**/ ?>