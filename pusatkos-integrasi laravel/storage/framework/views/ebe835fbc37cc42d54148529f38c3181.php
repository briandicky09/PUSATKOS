        ...
        <div class="container py-4">
            ...
            <div class="card border-0 shadow-sm mb-5" style="border-radius: 8px;">
                <div class="card-body p-4 p-md-5">
                    <h4 class="mb-4 font-weight-bold text-dark">Temukan Kos Sesuai Kebutuhanmu</h4>
                    
                    <form action="<?php echo e(route('owner.kos.index')); ?>" method="GET">
                        <div class="form-row align-items-end">
                            ...
                            <!-- DIUBAH: Warna tombol Cari menjadi biru solid -->
            ...
            <div class="row">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <h5 class="font-weight-bold text-dark mb-0">Rp 2.100.000 <span class="text-muted font-weight-normal ts-text-small">/ bulan</span></h5>
                        </div>
                        <div class="card-footer bg-white border-top-0 pb-4 pt-0">
                            <a href="<?php echo e(route('owner.kos.show', $kos['slug'] ?? 'kos-putri-melati')); ?>" class="btn btn-outline-dark w-100 font-weight-bold" style="border-radius: 4px;">Lihat Detail</a>
                        </div>
                    </div>
                </div>

            </div>
            <!-- end row hasil pencarian -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\PUSATKOS\pusatkos-integrasi laravel\resources\views/owner/kos/index.blade.php ENDPATH**/ ?>